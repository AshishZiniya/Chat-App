...
export default function StickerPickerComponent({ onStickerSelect, isOpen, onClose }: StickerPickerProps) {
  ...
  return (
    <div className="bg-white border border-gray-300 rounded-lg shadow-lg p-4 mx-auto" style={{ maxWidth: '320px', height: '400px' }}>
      <input
        type="text"
          ...
          <div className="grid grid-cols-4 gap-2">
            {stickers.map((sticker) => (
              <button
                key={sticker.id}
                onClick={() => {
                  onStickerSelect(sticker.images.fixed_height.url);
                  onClose();
                }}
